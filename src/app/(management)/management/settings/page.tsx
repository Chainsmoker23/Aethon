...
export default function SettingsPage() {
  ...
  return (
    <main className="p-4 md:p-6 lg:p-10 space-y-6 md:space-y-8 max-w-[1200px] mx-auto w-full pb-20 lg:pb-32">
        ...
        <div className="lg:hidden flex items-center justify-between p-3 bg-white border border-slate-200 rounded-xl shadow-sm animate-fade-in-up mb-4">
          <div className="flex items-center gap-3">
            ...
            <p className="font-bold text-xs text-slate-900 truncate max-w-[140px]">{userName}</p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 animate-fade-in-up delay-100">
          ...
          <div className="flex-1 bg-white border border-slate-200 rounded-2xl p-5 md:p-8 min-h-[500px] shadow-sm">
            {activeTab === "general" && (
              <div className="animate-fade-in space-y-8">
                ...
                <div className="space-y-5 max-w-md">
                  <div>
                    <label className="block text-sm font-bold text-slate-900 mb-2">Facility Name</label>
                    <input 
                      type="text" 
                      value={settings.facilityName}
                      onChange={(e) => setSettings({...settings, facilityName: e.target.value})}
                      className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/40 shadow-sm"
                    />
                  </div>
                  <div>
                    ...
                    <select 
                      ...
                      className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/40 appearance-none shadow-sm"
                    >
            ...
            {activeTab === "alerts" && (
              <div className="animate-fade-in space-y-8">
                <div>
                  <h2 className="text-xl font-bold text-slate-900">Alert Thresholds</h2>
                  <p className="text-sm font-medium text-slate-500 mt-1">Configure when the system generates automatic escalations.</p>
                </div>
                ...
                <div className="space-y-4 max-w-xl">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-2xl gap-4">
                    <div>
                      <p className="font-bold text-slate-900 text-sm">Missing Visit Alert</p>
                      <p className="text-xs font-medium text-slate-500 mt-0.5">Trigger an escalation if a client is not seen by this time.</p>
                    </div>
                    <input 
                      type="time" 
                      value={settings.alertTime}
                      onChange={(e) => setSettings({...settings, alertTime: e.target.value})}
                      className="bg-white border border-slate-200 rounded-lg px-3 py-1.5 text-sm font-bold text-slate-900 shadow-sm w-full sm:w-auto"
                    />
                  </div>

                  <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-2xl gap-4">
                    <div>
                      <p className="font-bold text-slate-900 text-sm">Family Notifications</p>
                      <p className="text-xs font-medium text-slate-500 mt-0.5">Send a push notification to family when an escalation is resolved.</p>
                    </div>
                    <button 
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-2xl gap-4">
                    <div>
                      <label className="block font-bold text-slate-900 text-sm">Heart Rate Threshold (BPM)</label>
                      <p className="text-xs font-medium text-slate-500 mt-0.5">Alert if heart rate goes outside this range.</p>
                    </div>
                    <div className="flex items-center gap-2 self-start sm:self-auto">
                      <input type="number" defaultValue="45" className="w-20 px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/20 shadow-sm text-center" />
                      <span className="text-sm font-medium text-slate-400">to</span>
                      <input type="number" defaultValue="120" className="w-20 px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/20 shadow-sm text-center" />
                    </div>
                  </div>

                  <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-2xl gap-4">
                    <div>
                      <label className="block font-bold text-slate-900 text-sm">Missed Medication Window</label>
                      <p className="text-xs font-medium text-slate-500 mt-0.5">Hours before escalation is generated.</p>
                    </div>
                    <input type="number" defaultValue="2" className="w-20 px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary/20 shadow-sm self-start sm:self-auto text-center" />
                  </div>
                </div>
              </div>
            )}
              ...
              <div className="animate-fade-in space-y-8">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm font-medium text-slate-500 mt-1">Manage dashboard access for your team.</p>
                  </div>
                ...
                <div className="bg-slate-50 border border-slate-200 rounded-2xl overflow-hidden">
                  <div className="px-5 py-4 border-b border-slate-200 flex items-center justify-between">
                     <span className="text-sm font-bold text-slate-900">Dr. Anna Weber</span>
                     <span className="text-xs font-bold text-primary bg-indigo-50 px-2 py-1 rounded-md">Admin</span>
                  </div>
                  <div className="px-5 py-4 flex items-center justify-between bg-white">
                     <span className="text-sm font-bold text-slate-900">Marcus Schmidt</span>
                     <span className="text-xs font-bold text-slate-500 bg-slate-100 px-2 py-1 rounded-md border border-slate-200">Caregiver</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {activeTab === "export" && (
              <div className="animate-fade-in space-y-8">
                <div>
                  ...
                  <p className="text-sm font-medium text-slate-500 mt-1">Export facility and resident data for compliance or offline backup.</p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
                    <div className="flex-1">
                      <h3 className="text-sm font-bold text-slate-900">Resident Care Records</h3>
                      <p className="text-xs font-medium text-slate-500 mt-1">Download complete timeline histories.</p>
                    </div>
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto shrink-0 mt-1 sm:mt-0">
                      <button 
                        ...
                        className="flex items-center justify-center gap-2 px-4 py-2.5 sm:py-2 bg-white text-slate-900 border border-slate-200 text-sm font-bold rounded-xl hover:bg-slate-50 transition-colors shadow-sm btn-press disabled:opacity-50 w-full sm:w-auto"
                      >
                  ...
                  <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
                    ...
                    <button 
                      ...
                      disabled={isExporting !== null}
                      className="flex items-center justify-center gap-2 px-4 py-2.5 sm:py-2 bg-white text-slate-900 border border-slate-200 text-sm font-bold rounded-xl hover:bg-slate-50 transition-colors shadow-sm btn-press disabled:opacity-50 w-full sm:w-auto shrink-0 mt-1 sm:mt-0"
                    >

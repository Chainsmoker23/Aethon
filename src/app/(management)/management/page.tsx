    ...
    <main className="p-4 md:p-6 lg:p-10 space-y-6 md:space-y-8 max-w-[1200px] mx-auto w-full pb-20 lg:pb-32">
        ...
        <div className="hidden md:flex items-start justify-between animate-fade-in-up">
          <div className="w-full">
            ...
            <div className="text-xs md:text-sm font-medium text-slate-500 dark:text-zinc-500 dark:text-slate-500 dark:text-zinc-500 mt-2 flex flex-wrap items-center gap-x-3 gap-y-2">
              ...
              <span className="inline-flex items-center gap-1.5 text-[10px] md:text-[11px] uppercase tracking-wider font-bold text-slate-700 dark:text-zinc-300 dark:text-slate-300 bg-white dark:bg-[#0a0a0a] px-2 py-1 md:px-3 md:py-1.5 rounded-md shadow-sm border border-slate-200 dark:border-zinc-800 shrink-0">

    ...
    <div className="flex flex-col h-full">
      <div className="bg-white border-b border-slate-200 sticky top-0 z-20 px-6 py-5 flex items-center justify-between shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-black text-slate-900 tracking-tight">Vitals & Meds</h1>
            <p className="text-sm font-semibold text-slate-500 mt-0.5">Live health data tracking</p>
          </div>
        </div>

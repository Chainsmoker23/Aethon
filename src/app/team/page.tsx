...
export default function TeamPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden bg-slate-50/50 landing-grid-bg [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      <nav className="sticky top-0 z-50 bg-white/60 backdrop-blur-2xl border-b border-slate-200/50">
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            ...
            >
              <Link href="/#features" onClick={() => setMobileMenuOpen(false)} className="text-lg font-bold text-navy py-2 border-b border-slate-100 flex items-center justify-between">
                Features <ChevronRight className="w-4 h-4 text-slate-400" />
              </Link>
              <Link href="/#how-it-works" onClick={() => setMobileMenuOpen(false)} className="text-lg font-bold text-navy py-2 border-b border-slate-100 flex items-center justify-between">
                How It Works <ChevronRight className="w-4 h-4 text-slate-400" />
              </Link>
              <Link href="/#trust" onClick={() => setMobileMenuOpen(false)} className="text-lg font-bold text-navy py-2 border-b border-slate-100 flex items-center justify-between">
      ...
      <section className="relative max-w-6xl mx-auto px-5 md:px-6 py-16 md:py-24 min-h-[70vh]">
        <Reveal>
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-sm md:text-lg text-slate-500 font-medium mt-4 max-w-2xl mx-auto px-2 md:px-0">
          ...
          <Reveal delay={100} className="h-full">
            ...
            >
              <img 
                src="/Flynn.jpg" 
                alt="Flynn Werner" 
                className="w-24 h-24 rounded-full object-cover shadow-xl shadow-sky-500/20 mb-6 shrink-0"
              />
          ...
          <Reveal delay={300} className="h-full">
            ...
            >
              <img 
                src="/Selena.jpg" 
                alt="Selena Nguyen" 
                className="w-24 h-24 rounded-full object-cover shadow-xl shadow-rose-500/20 mb-6 shrink-0"
              />

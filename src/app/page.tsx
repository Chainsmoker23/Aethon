            ...
            >
              <div
                className={`max-w-[85%] p-2.5 md:p-3 shadow-sm ${
                  msg.from === "staff"
                    ? "bg-white dark:bg-[#0a0a0a] rounded-2xl rounded-br-sm border border-slate-100 dark:border-zinc-800/50"
            ...
            >
              <div className={`px-4 py-2.5 rounded-2xl shadow-sm ${
                chatMessages[visibleCount].from === "staff"
                  ? "bg-white dark:bg-[#0a0a0a] border border-slate-100 dark:border-zinc-800/50 rounded-br-sm"
                  ...
                  {[0, 1, 2].map((dot) => (
                    <motion.div
                      ...
                      className={`w-1.5 h-1.5 rounded-full ${
                        chatMessages[visibleCount].from === "staff" ? "bg-slate-400" : "bg-white dark:bg-[#0a0a0a]/70"
                      }`}
                      animate={{ y: [0, -4, 0] }}
...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 dark:bg-zinc-900/50 landing-grid-bg [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      <nav className="sticky top-0 z-50 bg-white dark:bg-[#0a0a0a]/60 backdrop-blur-2xl border-b border-slate-200 dark:border-zinc-800/50">
        ...
        <AnimatePresence>
          {mobileMenuOpen && (
            ...
            >
              <a href="#features" onClick={() => setMobileMenuOpen(false)} className="text-lg font-bold text-navy py-2 border-b border-slate-100 dark:border-zinc-800/50 flex items-center justify-between">
                Features <ChevronRight className="w-4 h-4 text-text-muted" />
              </a>
              <a href="#how-it-works" onClick={() => setMobileMenuOpen(false)} className="text-lg font-bold text-navy py-2 border-b border-slate-100 dark:border-zinc-800/50 flex items-center justify-between">
                How It Works <ChevronRight className="w-4 h-4 text-text-muted" />
              </a>
              <a href="#trust" onClick={() => setMobileMenuOpen(false)} className="text-lg font-bold text-navy py-2 border-b border-slate-100 dark:border-zinc-800/50 flex items-center justify-between">
          ...
          <Reveal delay={300}>
            <div className="flex flex-col sm:flex-row items-center gap-3 md:gap-4 mt-10 md:mt-12 w-full sm:w-auto px-2 sm:px-0">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} transition={{ type: "spring", stiffness: 400, damping: 17 }} className="w-full sm:w-auto">
                <a
                  href="#how-it-works"
                  className="px-6 md:px-8 py-3.5 md:py-4 bg-white dark:bg-[#0a0a0a]/70 backdrop-blur-lg text-navy text-sm md:text-base font-bold rounded-2xl border border-slate-200 dark:border-zinc-800/60 hover:bg-white dark:bg-[#0a0a0a] shadow-sm hover:shadow-md flex items-center justify-center"
                >
                  See How It Works
                </a>
              </motion.div>
          ...
          <div>
            ...
            <div className="flex-1 flex flex-col gap-6">
              <div className="flex justify-between items-center">
                <div className="w-48 h-10 bg-white dark:bg-[#0a0a0a]/60 rounded-xl" />
                <div className="w-32 h-10 bg-white dark:bg-[#0a0a0a]/60 rounded-xl" />
              </div>
              <div className="flex-1 grid grid-cols-3 gap-4">
                <div className="col-span-2 bg-white dark:bg-[#0a0a0a]/60 border border-white/40 rounded-2xl p-5 shadow-sm flex flex-col gap-3">
                  <div className="w-32 h-4 bg-slate-200 dark:bg-slate-700/80 rounded-full" />
                  <div className="w-full h-20 bg-slate-100 dark:bg-zinc-900/50 rounded-xl mt-auto" />
                </div>
      ...
      <section className="relative max-w-6xl mx-auto px-5 md:px-6 py-12 md:py-24 border-t border-slate-200 dark:border-zinc-800/50">
          ...
          <Reveal direction="right">
            <div className="relative max-w-[200px] sm:max-w-[240px] md:max-w-[320px] mx-auto">
              ...
              <img 
                ...
                className="relative z-10 w-full h-auto drop-shadow-xl object-cover rounded-[40px] border border-slate-100 dark:border-zinc-800/50"
              />
            </div>
          </Reveal>
        </div>
          ...
          <Reveal direction="left" className="order-2 md:order-1 flex items-center justify-center">
            <div className="relative max-w-[280px] md:max-w-[360px] w-full mx-auto">
              ...
              <img 
                ...
                className="relative z-10 w-full h-auto drop-shadow-2xl object-cover rounded-[40px] bg-white dark:bg-[#0a0a0a] p-6 md:p-8 border border-slate-100 dark:border-zinc-800/50"
              />
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-2.5 md:space-y-4">
                  {["Daily care updates & photos", "Medication tracking", "Direct staff messaging", "Escalation notifications"].map((item) => (
                    <li key={item} className="flex items-center gap-2.5 md:gap-3 text-xs md:text-sm font-bold text-navy bg-white dark:bg-[#0a0a0a]/40 p-2 rounded-xl">
          ...
          <div className="relative rounded-3xl md:rounded-[40px] overflow-hidden border border-red-100">
            ...
            <div className="relative z-10 px-6 py-12 md:px-16 md:py-16">
              <div className="flex flex-col items-center text-center mb-10 md:mb-14">
                {/* Swiss badge */}
                <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-white dark:bg-[#0a0a0a] border border-red-200 shadow-sm mb-6">
              ...
              <div className="grid md:grid-cols-3 gap-5 md:gap-6">
                ...
                <Reveal delay={100}>
                  <div className="bg-white dark:bg-[#0a0a0a] rounded-2xl p-6 border border-slate-100 dark:border-zinc-800/50 shadow-sm h-full">
        ...
        <Reveal>
          <div className="relative rounded-3xl md:rounded-[40px] overflow-hidden shadow-2xl">
            ...
            <div className="relative z-20 px-5 py-12 md:px-16 md:py-24 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 dark:bg-[#0a0a0a]/10 border border-white/20 mb-5 md:mb-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4 mt-8 md:mt-12 w-full sm:w-auto">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} transition={{ type: "spring", stiffness: 400, damping: 17 }} className="w-full sm:w-auto">
                  <Link
                    href="/login"
                    className="group px-6 md:px-8 py-3.5 md:py-4 bg-white dark:bg-[#0a0a0a] text-navy text-sm md:text-base font-bold rounded-2xl hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-zinc-900 shadow-xl hover:shadow-2xl flex items-center justify-center gap-2"
                  >
                    Start Free Trial
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} transition={{ type: "spring", stiffness: 400, damping: 17 }} className="w-full sm:w-auto">
                  <a
                    href="#how-it-works"
                    className="px-6 md:px-8 py-3.5 md:py-4 bg-white/10 dark:bg-[#0a0a0a]/10 text-white text-sm md:text-base font-bold rounded-2xl border border-white/20 hover:bg-white/20 dark:hover:bg-[#0a0a0a]/20 backdrop-blur-sm flex items-center justify-center"
                  >
                    Learn More
                  </a>
                </motion.div>
      ...
      {/* === Footer === */}
      <footer className="border-t border-slate-200 dark:border-zinc-800/60 bg-white dark:bg-[#0a0a0a]/60 backdrop-blur-xl">

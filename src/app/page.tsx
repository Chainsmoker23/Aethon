...
function LiveChatDemo() {
 ...
 chatMessages[visibleCount].from === "staff" ? "bg-slate-400" : "bg-white "
 }`}
 animate={{ y: [0, -4, 0] }}
...
export default function LandingPage() {
 ...
 return (
 <div className="relative min-h-screen overflow-hidden bg-slate-50 text-slate-900 landing-grid-bg [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
 ...
 {/* === Navigation === */}
 <nav className="sticky top-0 z-50 bg-white backdrop-blur-2xl border-b border-slate-200 ">
 <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
 <div className="flex items-center gap-2.5">
 <img 
 src="/logo.jpg" 
 alt="Aethon Health Logo" 
 className="w-10 h-10 rounded-xl object-contain bg-white shadow-sm border border-slate-200 " 
 />
 ...
 className="md:hidden w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-navy hover:bg-slate-200 :bg-slate-700 transition-colors"
 >
 ...
 className="md:hidden absolute top-16 left-0 right-0 bg-white backdrop-blur-2xl border-b border-slate-200 shadow-2xl p-6 flex flex-col gap-4 origin-top"
 >
 ...
 <a
 href="#how-it-works"
 className="px-6 md:px-8 py-3.5 md:py-4 bg-white backdrop-blur-lg text-navy text-sm md:text-base font-bold rounded-2xl border border-slate-200 hover:bg-white shadow-sm hover:shadow-md flex items-center justify-center"
 >
 See How It Works
 </a>
 </motion.div>
 ...
 <div>
 <div className="max-w-4xl mx-auto bg-white backdrop-blur-3xl border border-white/60 rounded-t-[40px] shadow-2xl overflow-hidden h-[300px] p-6 flex gap-6 mask-bottom glass-glare">
 {/* Sidebar Mockup */}
 <div className="w-48 bg-white rounded-2xl p-4 border border-white/40 flex flex-col gap-3">
 ...
 <div className="w-48 h-10 bg-white rounded-xl" />
 <div className="w-32 h-10 bg-white rounded-xl" />
 </div>
 <div className="flex-1 grid grid-cols-3 gap-4">
 <div className="col-span-2 bg-white border border-white/40 rounded-2xl p-5 shadow-sm flex flex-col gap-3">
 <div className="w-32 h-4 bg-slate-200 rounded-full" />
 <div className="w-full h-20 bg-slate-100 rounded-xl mt-auto" />
 </div>
 ...
 <section className="relative max-w-6xl mx-auto px-5 md:px-6 py-12 md:py-24 border-t border-slate-200 ">
 ...
 <div className="absolute inset-0 bg-slate-200 rounded-[40px] -rotate-3 blur-sm transform scale-105 opacity-60" />
 <img 
 ...
 <div className="mt-auto relative z-10 bg-white border border-white/80 p-3 md:p-4 rounded-xl md:rounded-2xl shadow-sm">
 ...
 <li key={item} className="flex items-center gap-2.5 md:gap-3 text-xs md:text-sm font-bold text-navy bg-white p-2 rounded-xl">
 ...
 {/* === Footer === */}
 <footer className="border-t border-slate-200 bg-white backdrop-blur-xl">

      ...
      {residents.map((r) => {
        ...
        return (
          <div key={r.id} className="group">
            <div
              className={`flex flex-col gap-1.5 cursor-pointer hover:bg-slate-50 dark:hover:bg-[#111] transition-colors p-3 ${r.escalations > 0 ? "bg-red-50 dark:bg-red-900/30 border-l-[4px] border-red-500" : "border-l-[4px] border-transparent"}`}
            ...
            {/* Expanded Area */}
            {isExpanded && (
              <div className="bg-slate-50 dark:bg-[#0a0a0a] px-4 py-4 border-t border-slate-100 dark:border-zinc-800/50 shadow-inner">

  ...
  return (
    <div className="flex flex-col h-full bg-slate-50 dark:bg-zinc-900/50 rounded-2xl border border-border/50 dark:border-zinc-800/50 overflow-hidden shadow-inner relative animate-fade-in">
      ...
      <div className="p-4 bg-white dark:bg-[#0a0a0a] border-t border-border/50 dark:border-zinc-800/50 shrink-0">
        ...
        <form onSubmit={handleSend} className="flex items-end gap-2 bg-slate-50 dark:bg-zinc-900/50 border border-slate-200 dark:border-zinc-800/80 rounded-2xl p-1.5 focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary/40 focus-within:bg-white dark:bg-[#0a0a0a] transition-all shadow-sm">
          <textarea
